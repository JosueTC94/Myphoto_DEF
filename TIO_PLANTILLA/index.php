    ...
    <figure id="" class="effect-oscar  wowload fadeIn">
     ...
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            ...
            <a href="#about" id="2" title="">Info foto</a>         
	    </p>
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            ...
            <p>Lily likes to play with crayons and pencils<br>
            <a href="images/portfolio/3.jpg" title="1" data-gallery>View more</a>            
            <a href="#about" id="3" title="">Info foto</a>
	    </p>
	</figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
...
-->
 ...
 <table id="detalles_foto" class="table table-bordered table-condensed table-hover">
				...
				<tr>
				     <td>Altitud imagen:</td>
			             <td id="altitud_imagen"></td>
				</tr>
                            </tbody>
         </table>
  </div>
